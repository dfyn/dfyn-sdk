...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = '0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac', _FACTORY_ADDRESS[ChainId.ROPSTEN] = '0xc35DADB65012eC5796536bD9864eD8773aBc74C4', _FACTORY_ADDRESS[ChainId.RINKEBY] = '0xc35DADB65012eC5796536bD9864eD8773aBc74C4', _FACTORY_ADDRESS[ChainId.GÖRLI] = '0xc35DADB65012eC5796536bD9864eD8773aBc74C4', _FACTORY_ADDRESS[ChainId.KOVAN] = '0xc35DADB65012eC5796536bD9864eD8773aBc74C4', _FACTORY_ADDRESS[ChainId.MATIC] = '0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B', _FACTORY_ADDRESS[ChainId.OKEX] = '0xE7Fb3e833eFE5F9c441105EB65Ef8b261266423B', _FACTORY_ADDRESS[ChainId.ARBITRUM] = '0xa102072a4c07f06ec3b4900fdc4c7b80b6c57429', _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.MAINNET] = '0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F', _ROUTER_ADDRESS[ChainId.RINKEBY] = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506', _ROUTER_ADDRESS[ChainId.ROPSTEN] = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506', _ROUTER_ADDRESS[ChainId.GÖRLI] = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506', _ROUTER_ADDRESS[ChainId.KOVAN] = '0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506', _ROUTER_ADDRESS[ChainId.MATIC] = '0xA102072A4C07F06EC3B4900FDC4C7B80b6c57429', _ROUTER_ADDRESS[ChainId.OKEX] = '0x34686CBF7229ed0bff2Fbe7ED2CFC916317764f6', _ROUTER_ADDRESS[ChainId.ARBITRUM] = '0xaedE1EFe768bD8A1663A7608c63290C60B85e71c', _ROUTER_ADDRESS); // export const INIT_CODE_HASH = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3'

var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.RINKEBY] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.ROPSTEN] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.GÖRLI] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.KOVAN] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.MATIC] = '0xf187ed688403aa4f7acfada758d8d53698753b998a3071b06f1b777f4330eaf3', _INIT_CODE_HASH[ChainId.OKEX] = '0xd9fecb0a9f5bfd6ce2daf90b441ed5860c3fed2fcde57ba9819eb98d2422e418', _INIT_CODE_HASH[ChainId.ARBITRUM] = '0xd49917af2b31d70ba7bea89230a93b55d3b6a99aacd03a72c288dfe524ec2f36', _INIT_CODE_HASH);
...
Currency.NATIVE = (_Currency$NATIVE = {}, _Currency$NATIVE[ChainId.MAINNET] = Currency.ETHER, _Currency$NATIVE[ChainId.ROPSTEN] = Currency.ETHER, _Currency$NATIVE[ChainId.RINKEBY] = Currency.ETHER, _Currency$NATIVE[ChainId.GÖRLI] = Currency.ETHER, _Currency$NATIVE[ChainId.KOVAN] = Currency.ETHER, _Currency$NATIVE[ChainId.MATIC] = Currency.MATIC, _Currency$NATIVE[ChainId.OKEX] = Currency.OKT, _Currency$NATIVE[ChainId.ARBITRUM] = Currency.ETHER, _Currency$NATIVE);
var NATIVE = Currency.ETHER;
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'DFYNLP', 'Dfyn LP Token');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || !(input instanceof Token) && input instanceof Currency && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || !(output instanceof Token) && output instanceof Currency && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : !(route.input instanceof Token) && route.input instanceof Currency ? new CurrencyAmount(route.input, amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : !(route.output instanceof Token) && route.output instanceof Currency ? new CurrencyAmount(route.output, amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof TokenAmount ? new TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut) : new CurrencyAmount(this.outputAmount.currency, slippageAdjustedAmountOut);
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === TradeType.EXACT_INPUT) {
      ...
      return this.inputAmount instanceof TokenAmount ? new TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn) : new CurrencyAmount(this.inputAmount.currency, slippageAdjustedAmountIn);
    }
  }
  /**
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchTokenData = function fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      if (provider === undefined) provider = getDefaultProvider("https://rpc-mainnet.maticvigil.com/v1/1fcb1711b433804cea13ef670b1a5245c27562a6");
...
export { ChainId, Currency, CurrencyAmount, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, NATIVE, Pair, Percent, Price, ROUTER_ADDRESS, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
