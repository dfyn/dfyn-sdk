...
export const V2_FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.GÖRLI]: '',
  [ChainId.KOVAN]: '',
  [ChainId.MATIC]: '0x7ED245AADAcD826dfF9478de019e76FfF7c202fC',
  [ChainId.OKEX]: '',
  [ChainId.ARBITRUM]: '',
  [ChainId.XDAI]: '',
  [ChainId.FANTOM]: '',
...
export const V2_DEPLOYER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.GÖRLI]: '',
  [ChainId.KOVAN]: '',
  [ChainId.MATIC]: '0x20F200c65bDD173Df64a528e28F77F06ebDE61D9',
  [ChainId.OKEX]: '',
  [ChainId.ARBITRUM]: '',
  [ChainId.XDAI]: '',
  [ChainId.FANTOM]: '',
...
export const V2_MASTER_DEPLOYER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.GÖRLI]: '',
  [ChainId.KOVAN]: '',
  [ChainId.MATIC]: '0xaba5e148b0CB58e545d1E4D645EBBD6c250288b4',
  [ChainId.OKEX]: '',
  [ChainId.ARBITRUM]: '',
  [ChainId.XDAI]: '',
  [ChainId.FANTOM]: '',
...
export const V2_POOL_INIT_CODE_HASH: { [chainId in ChainId]: string } = {
  ...
  [ChainId.GÖRLI]: '',
  [ChainId.KOVAN]: '',
  [ChainId.MATIC]: '0x927b92e6ba1767fdf9098da147c98f2e3f30c9507dd81ece2a3a4951c0614b43',
  [ChainId.OKEX]: '',
  [ChainId.ARBITRUM]: '',
  [ChainId.XDAI]: '',
  [ChainId.FANTOM]: '',
