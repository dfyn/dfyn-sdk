import { TokenAmount, Price, Token } from './index'
import JSBI from 'jsbi'
import invariant from 'tiny-invariant'
import { V2_DEPLOYER_ADDRESS, FeeAmount, TICK_SPACINGS,BigintIsh } from '../constants'
...
export class Pool {
  ...
  // dfyn: we are computing pool address using to factory(deployer address),
  public static getAddress(
    ...
    return computePoolAddress({
      deployerAddress: deployerAddressOverride ?? V2_DEPLOYER_ADDRESS[tokenA.chainId],
      tokenA,
      tokenB,
  ...
  // // // // // // // // // // // // // // // // // // // // // // // // // // //
  // // // // // Swap Logic needs to be modified how we are doing it// // // // // 
  // // // // // // // // // // // // // // // // // // // // // // // // // // //
  /**
   * Executes a swap
