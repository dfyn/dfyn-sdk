import { BigintIsh, Percent, Price, CurrencyAmount } from '../index'
...
/**
 * Represents a position on a Dfyn V2 Pool
 */
export class Position {
  ...
  public constructor({ pool, liquidity, tickLower, tickUpper }: PositionConstructorArgs) {
    ...
    invariant((tickLower % pool.tickSpacing )%2=== 0, 'TICK_LOWER_ODD')
    invariant((tickUpper % pool.tickSpacing )%2=== 0, 'TICK_UPPER_EVEN')
